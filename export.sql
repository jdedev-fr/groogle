...
-- Listage de la structure de la base pour world
...
-- Listage de la structure de la table world. city
...
-- Listage des données de la table world.city : ~4 079 rows (environ)
DELETE FROM `city`;
...
-- Listage de la structure de la table world. country
...
-- Listage des données de la table world.country : ~239 rows (environ)
DELETE FROM `country`;
...
-- Listage de la structure de la table world. countrylanguage
...
-- Listage des données de la table world.countrylanguage : ~984 rows (environ)
